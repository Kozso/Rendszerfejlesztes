 ...
 * @author Dani
 */
@WebServlet(urlPatterns = {"/kosarTorlesServlet"})
public class kosarTorlesServlet extends HttpServlet {
...
//        String jelszo = request.getParameter("jelszo");
        ...
        int kosar_id = Integer.parseInt(request.getParameter("kosar.kosar_id"));
        int user_id =(int) session.getAttribute("user_id");
        
        System.out.println("ID , kosar_id");
        System.out.println(user_id+" "+kosar_id);
        ...
        try {
            ...
            PreparedStatement ps_kosar = con.prepareStatement("delete from kosar where kosar_id=?");
            ps_kosar.setInt(1, kosar_id);
